...
fir_Al = openmc.Cell(
    name="第1层Al",
    fill=Al_pure,
    region=+fir_Al_ins & -fir_Al_out & +core_low & -core_upp,
)
sec_H2O = openmc.Cell(name="第2层H2O", fill=H2O, region=+fir_Al_out & -sec_H2O_out & +core_low & -core_upp)
thi_Al = openmc.Cell(
    name="第3层Al",
    fill=Al_pure,
    region=+sec_H2O_out & -thi_Al_out & +core_low & -core_upp,
)
fou_Pb = openmc.Cell(name="第4层Pb", fill=Pb, region=+thi_Al_out & -fou_Pb_out & +core_low & -core_upp)
fif_Al = openmc.Cell(
    name="第5层Al",
    fill=Al_pure,
    region=+fou_Pb_out & -fif_Al_out & +core_low & -core_upp,
)
six_H2O = openmc.Cell(
    name="最外围H2O",
    fill=H2O,
    region=(+fif_Al_out & -six_H2O_out & +core_low & -core_upp)
    | (+fir_Al_ins & -six_H2O_out & +core_upp & -H2O_upp)
    | (+fir_Al_ins & -six_H2O_out & -core_low & +H2O_low),
)
...
f_fuel_core = openmc.Cell(
    name="燃料芯",
    fill=UHZr,
    region=+fuelRod_Zr_out & -fuelRod_core_out & +fuelRod_core_low & -fuelRod_core_upp,
)
f_He = openmc.Cell(
    name="He气隙",
    fill=He,
    region=+fuelRod_core_out & -fuelRod_He_out & +fuelRod_core_low & -fuelRod_core_upp,
)
f_graphite_upp = openmc.Cell(
    name="上石墨",
    fill=Graphite,
    region=-fuelRod_He_out & +fuelRod_core_upp & -fuelRod_upper_graphite_upp,
)
f_graphite_low = openmc.Cell(
    name="下石墨",
    fill=Graphite,
    region=-fuelRod_He_out & +fuelRod_lower_graphite_low & -fuelRod_core_low,
)
f_SS_side = openmc.Cell(
    name="包壳侧",
    fill=SS,
    region=+fuelRod_He_out & -fuelRod_clad_out & +fuelRod_lower_graphite_low & -fuelRod_upper_graphite_upp,
)
f_SS_upp = openmc.Cell(
    name="包壳上",
    fill=SS,
    region=-fuelRod_clad_out & +fuelRod_upper_graphite_upp & -fuelRod_clad_upp,
)
f_SS_low = openmc.Cell(
    name="包壳下",
    fill=SS,
    region=-fuelRod_clad_out & +fuelRod_clad_low & -fuelRod_lower_graphite_low,
)
f_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+fuelRod_clad_out | -fuelRod_clad_low | +fuelRod_clad_upp,
)  # TODO Check it!

# 燃料棒Universe
fuelUni = openmc.Universe(
    name="燃料棒",
    cells=[
        f_Zr_core,
        f_fuel_core,
...
# 不锈钢栅元
s_SS_core = openmc.Cell(
    name="不锈钢芯",
    fill=SS,
    region=-fuelRod_core_out & +fuelRod_core_low & -fuelRod_core_upp,
)
s_He = openmc.Cell(
    name="He气隙",
    fill=He,
...
s_upper_Al = openmc.Cell(
    name="上Al",
    fill=Al,
    region=-fuelRod_He_out & +fuelRod_core_upp & -fuelRod_upper_graphite_upp,
)
s_lower_Al = openmc.Cell(
    name="下Al",
    fill=Al,
    region=-fuelRod_He_out & +fuelRod_lower_graphite_low & -fuelRod_core_low,
)
s_side_clad = openmc.Cell(
    name="包壳侧",
    fill=SS,
    region=+fuelRod_He_out & -fuelRod_clad_out & +fuelRod_lower_graphite_low & -fuelRod_upper_graphite_upp,
)
s_upper_clad = openmc.Cell(
    name="包壳上",
    fill=SS,
    region=-fuelRod_clad_out & +fuelRod_upper_graphite_upp & -fuelRod_clad_upp,
)
s_lower_clad = openmc.Cell(
    name="包壳下",
    fill=SS,
    region=-fuelRod_clad_out & +fuelRod_clad_low & -fuelRod_lower_graphite_low,
)
s_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+fuelRod_clad_out | -fuelRod_clad_low | +fuelRod_clad_upp,
)
...
# 石墨栅元
g_graphite_core = openmc.Cell(
    name="石墨芯",
    fill=Graphite,
    region=-graphiteRod_graphite_out & +graphiteRod_graphite_low & -graphiteRod_graphite_upp,
)
g_He = openmc.Cell(
    name="He气隙",
    fill=He,
    region=+graphiteRod_graphite_out & -graphiteRod_He_out & +graphiteRod_graphite_low & -graphiteRod_graphite_upp,
)
g_Al_side = openmc.Cell(
    name="Al包壳侧",
    fill=Al,
    region=+graphiteRod_He_out & -graphiteRod_clad_out & +graphiteRod_graphite_low & -graphiteRod_graphite_upp,
)
g_Al_upp = openmc.Cell(
    name="Al包壳顶部",
    fill=Al,
    region=-graphiteRod_clad_out & +graphiteRod_graphite_upp & -graphiteRod_clad_upp,
)
g_Al_low = openmc.Cell(
    name="Al包壳底部",
    fill=Al,
    region=-graphiteRod_clad_out & +graphiteRod_clad_low & -graphiteRod_graphite_low,
)
g_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+graphiteRod_clad_out | -graphiteRod_clad_low | +graphiteRod_clad_upp,
)

# 石墨栅元Universe
graphiteUni = openmc.Universe(
    name="石墨棒",
    cells=[g_graphite_core, g_He, g_Al_side, g_Al_upp, g_Al_low, g_H2O_around],
)
...
# 带燃料跟随体的控制棒栅元
c_Zr_core = openmc.Cell(
    name="Zr芯",
    fill=Zr,
    region=-controlRod_Zr_out & +controlRod_fuelCore_low & -controlRod_B4C_low,
)
c_fuel_core = openmc.Cell(
    name="燃料芯",
    fill=UHZr,
    region=+controlRod_Zr_out & -controlRod_core_out & +controlRod_fuelCore_low & -controlRod_B4C_low,
)
c_He_UHZr = openmc.Cell(
    name="UHZr周围He气隙",
    fill=He,
    region=+controlRod_core_out & -controlRod_He_out & +controlRod_fuelCore_low & -controlRod_B4C_low,
)
c_B4C = openmc.Cell(
    name="B4C",
    fill=B4C,
    region=-controlRod_B4C_out & +controlRod_B4C_low & -controlRod_upper_graphite_low,
)
c_He_B4C = openmc.Cell(
    name="B4C周围He气隙",
    fill=He,
    region=+controlRod_B4C_out & -controlRod_He_out & +controlRod_B4C_low & -controlRod_upper_graphite_low,
)
c_graphite_upp = openmc.Cell(
    name="上石墨",
    fill=Graphite,
    region=-controlRod_He_out & +controlRod_upper_graphite_low & -controlRod_upper_graphite_upp,
)
c_graphite_low = openmc.Cell(
    name="下石墨",
    fill=Graphite,
    region=-controlRod_He_out & +controlRod_lower_graphite_low & -controlRod_fuelCore_low,
)
c_SS_side = openmc.Cell(
    name="包壳侧",
    fill=SS,
    region=+controlRod_He_out & -controlRod_clad_out & +controlRod_lower_graphite_low & -controlRod_upper_graphite_upp,
)
c_SS_upp = openmc.Cell(
    name="包壳上",
    fill=SS,
    region=-controlRod_clad_out & +controlRod_upper_graphite_upp & -controlRod_clad_upp,
)
c_SS_low = openmc.Cell(
    name="包壳下",
    fill=SS,
    region=-controlRod_clad_out & +controlRod_clad_low & -controlRod_lower_graphite_low,
)
c_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+controlRod_clad_out | -controlRod_clad_low | +controlRod_clad_upp,
)

# 带燃料跟随体的控制棒Universe
controlUni = openmc.Universe(
    name="控制棒",
    cells=[
        c_Zr_core,
        c_fuel_core,
...
# 脉冲棒栅元
p_B4C_core = openmc.Cell(
    name="B4C芯",
    fill=B4C,
    region=-pulseRod_B4C_out & +pulseRod_B4C_low & -pulseRod_B4C_upp,
)
p_Air_side = openmc.Cell(
    name="Air侧",
    fill=Air,
    region=+pulseRod_B4C_out & -pulseRod_Air_out & +pulseRod_B4C_low & -pulseRod_B4C_upp,
)
p_Air_upp = openmc.Cell(
    name="Air上",
    fill=Air,
    region=-pulseRod_Air_out & +pulseRod_B4C_upp & -pulseRod_upper_air_upp,
)
p_Air_low = openmc.Cell(
    name="Air下",
    fill=Air,
    region=-pulseRod_Air_out & +pulseRod_lower_air_low & -pulseRod_B4C_low,
)
p_SS_side = openmc.Cell(
    name="包壳侧",
    fill=SS,
    region=+pulseRod_Air_out & -pulseRod_clad_out & +pulseRod_lower_air_low & -pulseRod_upper_air_upp,
)
p_SS_upp = openmc.Cell(
    name="包壳顶部",
    fill=SS,
    region=-pulseRod_clad_out & +pulseRod_upper_air_upp & -pulseRod_clad_upp,
)
p_SS_low = openmc.Cell(
    name="包壳底部",
    fill=SS,
    region=-pulseRod_clad_out & +pulseRod_clad_low & -pulseRod_lower_air_low,
)
p_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+pulseRod_clad_out | -pulseRod_clad_low | +pulseRod_clad_upp,
)

# 脉冲棒栅元Universe
pulseRodUni = openmc.Universe(
    name="脉冲棒",
    cells=[
        p_B4C_core,
        p_Air_side,
...
# 中子源栅元
n_AmO2_Be = openmc.Cell(
    name="中子源",
    fill=AmO2_Be,
    region=-neuSource_source_out & +neuSource_source_low & -neuSource_source_upp,
)
n_packing_side = openmc.Cell(
    name="源外包装侧",
    fill=SS,
    region=+neuSource_source_out & -neuSource_source_packing_out & +neuSource_source_low & -neuSource_source_upp,
)
n_packing_upp = openmc.Cell(
    name="源外包装上",
    fill=SS,
    region=-neuSource_source_packing_out & +neuSource_source_upp & -neuSource_source_packing_upp,
)
n_packing_low = openmc.Cell(
    name="源外包装下",
    fill=SS,
    region=-neuSource_source_packing_out & +neuSource_source_packing_low & -neuSource_source_low,
)
n_Air_upp = openmc.Cell(
    name="Air上",
    fill=Air,
    region=-neuSource_source_packing_out & +neuSource_source_packing_upp & -neuSource_upper_air_upp,
)
n_Air_low = openmc.Cell(
    name="Air下",
    fill=Air,
    region=-neuSource_source_packing_out & +neuSource_lower_air_low & -neuSource_source_packing_low,
)
n_SS_side = openmc.Cell(
    name="包壳侧",
    fill=SS,
    region=+neuSource_source_packing_out & -neuSource_clad_out & +neuSource_lower_air_low & -neuSource_upper_air_upp,
)
n_SS_upp = openmc.Cell(
    name="包壳顶部",
    fill=SS,
    region=-neuSource_clad_out & +neuSource_upper_air_upp & -neuSource_clad_upp,
)
n_SS_low = openmc.Cell(
    name="包壳底部",
    fill=SS,
    region=-neuSource_clad_out & +neuSource_clad_low & -neuSource_lower_air_low,
)
n_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+neuSource_clad_out | -neuSource_clad_low | +neuSource_clad_upp,
)

# 中子源Universe
neuSourceUni = openmc.Universe(
    name="中子源",
    cells=[
        n_AmO2_Be,
        n_packing_side,
...
r_Air = openmc.Cell(
    name="管内空气",
    fill=Air,
    region=-runRabbit_pipe_ins & +runRabbit_low & -runRabbit_upp,
)
r_SS = openmc.Cell(
    name="管",
    fill=SS,
    region=+runRabbit_pipe_ins & -runRabbit_pipe_out & +runRabbit_low & -runRabbit_upp,
)
r_H2O_around = openmc.Cell(
    name="外侧水",
    fill=H2O,
    region=+runRabbit_pipe_out | -runRabbit_low | +runRabbit_upp,
)
...
############################################################################
# 新中央跑兔栅元曲面
def update_geometry(p=[170, 180, 205, 210, -700, -300, -275, -265, 200, 250, 2200, 2940, 3600]):
    ...
    mat1 = SS
    n_r_side_clad = openmc.Cell(
        name="外部包壳",
        fill=mat1,
        region=+newRabbit_fuel_out & -newRabbit_clad_out & +newRabbit_lower_clad_upp & -newRabbit_upper_clad_low,
    )
    n_r_upper_clad = openmc.Cell(
        name="上部包壳",
        fill=mat1,
        region=-newRabbit_clad_out & +newRabbit_upper_clad_low & -newRabbit_upper_clad_upp,
    )
    n_r_lower_clad = openmc.Cell(
        name="下部包壳",
        fill=mat1,
        region=-newRabbit_clad_out & +newRabbit_lower_clad_low & -newRabbit_lower_clad_upp,
    )
    mat2 = Air
    n_r_upper_Air = openmc.Cell(
        name="上部Air",
        fill=mat2,
        region=-newRabbit_Air_out & +newRabbit_lid_upp & -newRabbit_upper_clad_low,
    )
    n_r_lower_Air = openmc.Cell(
        name="下部Air",
        fill=mat2,
        region=-newRabbit_Air_out & +newRabbit_Cd_upp & -newRabbit_Cd_side_upp,
    )
    mat3 = Cd
    n_r_lid = openmc.Cell(
        name="盖",
        fill=Air,
        region=-newRabbit_Air_out & +newRabbit_Cd_side_upp & -newRabbit_lid_upp,
    )  # TODO CHECK这里把Cd盖改为了Air
    n_r_bottom_Cd = openmc.Cell(
        name="Cd包层底",
        fill=mat3,
        region=-newRabbit_Cd_out & +newRabbit_fuel_upp & -newRabbit_Cd_upp,
    )
    n_r_side_Cd = openmc.Cell(
        name="Cd包层side",
        fill=mat3,
        region=+newRabbit_Air_out & -newRabbit_Cd_out & +newRabbit_Cd_upp & -newRabbit_Cd_side_upp,
    )
    mat4 = Cd
    n_r_upper_Cd = openmc.Cell(
        name="Cd上包层",
        fill=mat4,
        region=+newRabbit_Air_out & -newRabbit_fuel_out & +newRabbit_Cd_side_upp & -newRabbit_Cd_clad_upp,
    )
    mat5 = UO2
    n_r_bottom_fuel = openmc.Cell(
        name="燃料底",
        fill=mat5,
        region=-newRabbit_fuel_out & +newRabbit_lower_clad_upp & -newRabbit_fuel_upp,
    )
    n_r_side_fuel = openmc.Cell(
        name="燃料side",
        fill=mat5,
        region=+newRabbit_Cd_out & -newRabbit_fuel_out & +newRabbit_fuel_upp & -newRabbit_Cd_side_upp,
    )
    mat6 = SS
    n_r_upper_Al = openmc.Cell(
        name="Al上包层",
        fill=mat6,
        region=+newRabbit_Air_out & -newRabbit_fuel_out & +newRabbit_Cd_clad_upp & -newRabbit_upper_clad_low,
    )
    n_r_H2O_around = openmc.Cell(
        name="外侧水",
        fill=H2O,
        region=+newRabbit_upper_clad_upp | -newRabbit_lower_clad_low | +newRabbit_clad_out,
    )
